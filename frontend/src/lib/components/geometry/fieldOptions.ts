...
export const FIELD_OPTIONS: Record<string, FieldOptions> = {
  ...
  'CylinderX.material':        KNOWN_MATERIALS,
  'CylinderX.boundary_type':   BOUNDARY_TYPES,
  'CylinderY.material':        KNOWN_MATERIALS,
  'CylinderY.boundary_type':   BOUNDARY_TYPES,
  'CylinderZ.material':        KNOWN_MATERIALS,
  'CylinderZ.boundary_type':   BOUNDARY_TYPES,
  'ConeZ.material':            KNOWN_MATERIALS,
  'ConeZ.boundary_type':       BOUNDARY_TYPES,
  'Torus.material':            KNOWN_MATERIALS,
  'Torus.boundary_type':       BOUNDARY_TYPES,
